...
public class StringTool {
	...
	// public static String getUserId(HttpSession session, UserInfo user) { //识别 HT id
	// 	String htId = HtTools.getUserId(session);
	// 	if (htId == null) {

	// 		if (user == null || StringTool.isEmpty(user.getName())) {
	// 			return UmcConstants.anonymous;
	// 		}
	// 		else {
	// 			return user.getName();
	// 		}
