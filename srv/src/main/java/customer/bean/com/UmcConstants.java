...
public class UmcConstants {
    ...
    public static String SYS_NAME = "UWMS"; // 系统名称
    ...
    public final static String PCH05_CONFIRM = "確定"; 
    public final static String PCH05_CANCEL  = null; 
    ...
    public final static String POST_STATUS_C = "C"; // 転記取消
