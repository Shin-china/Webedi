sap.ui.define([
    ...
    return Controller.extend("umc.app.controller.pch.pch02_main", {
        onInit: function () {
            // 加载默认的详细视图
            const defaultView = sap.ui.xmlview("umc.app.view.pch.pch02_user_d");
        ...
        onTabSelect: function (oEvent) {
            ...
            if (selectedKey === "listView") {
                const listView = sap.ui.xmlview("umc.app.view.pch.pch02_user_l");
                oView.byId("idIconTabBar").addContent(listView);
            } else if (selectedKey === "detailView") {
                const detailView = sap.ui.xmlview("umc.app.view.pch.pch02_user_d");
