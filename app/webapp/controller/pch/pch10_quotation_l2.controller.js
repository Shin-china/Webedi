sap.ui.define(["umc/app/Controller/BaseController", "sap/m/MessageToast"], function (Controller, MessageToast) {
  ...
  return Controller.extend("umc.app.controller.pch.pch10_quotation_l2", {
    // onInit: function () {
    //   //  设置版本号
    //   this._setOnInitNo("INV34", "20240613");
    //   //显示页面
    //   this.getRouter().getRoute("RouteList_inv34").attachPatternMatched(this._onObjectMatched, this);
    ...
    //   let ID = object.H_ID;
    //   console.log(ID);
    //   this._onPress(oEvent, "RouteView_inv34", ID);
    // },
